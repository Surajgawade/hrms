						...
						<tbody>
							<?php if(!empty($attendance_list)) {
								...
								<tr>
									...
									<td><a  href="<?php echo site_url('attendance/own_attendance_details/').$value['month'].'/'.$value['year']; ?>" class="tabledit-edit-button btn btn-primary btn-sm btn_edit"><span></span>View</a></td>
								</tr>
							<?php } } 
							//else { ?>
								<!-- <tr>
