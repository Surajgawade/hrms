		...
		<div class="tbl">
			<div class="tbl-row">
				...
				<div class="add_btn col-md-2">
					<a href="<?php echo site_url();?>/rpo_manager/add_billing/<?php echo $this->uri->segment(3);?>">
...
<script>
	...
	function delete_data(id)
	{
		swal({
			...
			var  bill_id = id;
			$.ajax({
				url: '<?php echo site_url();?>/rpo_manager/delete_billing',
...
function get_billing()
{
	...
	var is_exist = '<?php //echo check_record_exist($tablename='rpo_billing', $conditions = array('can_id' =>$this->uri->segment(3)));?>';
	oTable = $('#billing_list').DataTable({
		...
		'sAjaxSource'    : '<?php echo site_url();?>'+'/rpo_manager/billing_details/'+id,
