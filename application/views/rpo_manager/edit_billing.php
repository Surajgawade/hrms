						...
						<div class="col-sm-12 col-xs-12 profile_bg">
							<div class="row">
								...
								<div class="col-lg-4 col-sm-3 col-xs-12">
									<div class="form-group">
										<div class="form-control-wrapper form-control-icon-right">
											<select required id="rate_type" name="rate_type" class="web chosen-select" style="width: 100%">
		...
		{		
			...
			else
			{
				...
				$.ajax({
					...
					data : {can_id: can_id, bill_id:bill_id, rate_type: rate_type,amount:amount,client_id:client_id,project_id,from_date:from_date,to_date:to_date,review_date:review_date},
					type: 'POST',
