<body class="with-side-menu-addl-full">
				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/rpo_manager/generate_rposalary_slip">
	...
	function list_monthly_salaryslips()
	{
		...
		oTable = $('#list_monthly_salaryslips').DataTable({
			...
			'sAjaxSource'    : '<?php echo site_url();?>'+'/rpo_manager/list_monthly_salaryslips',
	...
	function delete_salaryslip(rpo_sal_id)
	{
		swal({
			...
			$.ajax({
				url: '<?php echo site_url();?>/rpo_manager/delete_salaryslip',
