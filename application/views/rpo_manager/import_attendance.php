	...
	<div class="col-sm-12 well">
		 <div class="row">
				<form class="col-sm-12" id="myform"  method="post">
					<h1 class="well headline">Import RPO Attendance</h1>
						...
						<div class="row">
							...
							<div class="col-lg-10">
								<div class="form-group img-responsive">
									<a href="<?php echo base_url().'assets/img/rpo_attendance_sheet.xls' ?>" target="_blank"><img class="img-responsive" src="<?php echo base_url().'assets/img/rpo_attendance.png' ?>"></a>
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		else
		{
			...
			$.ajax({
				url: '<?php echo site_url();?>/rpo_manager/save_attendance',
				data: formData,
				processData: false,
				contentType: false,
				type: 'POST',
