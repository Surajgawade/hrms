				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/candidate/add_investment/<?php echo $this->uri->segment(3);?>">
...
<script>
	...
	function get_investments()
	{
		...
		oTable = $('#investment_list').DataTable({
			...
			'sAjaxSource'    : '<?php echo site_url();?>'+'/candidate/investment_details/'+id,
	...
	{		
		swal({
			...
			var  inv_id = id;
			$.ajax({
				url: '<?php echo site_url();?>/candidate/delete_investment',
				data : {inv_id: inv_id},
				type: 'POST',
