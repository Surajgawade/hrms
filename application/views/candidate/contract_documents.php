				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/candidate/add_document/<?php echo $this->uri->segment(3);?>">
...
function get_documents()
{
   ...
   var is_exist = '<?php echo check_record_exist($tablename='candidate', $conditions = array('can_id' =>$this->uri->segment(3)));?>'; 
	oTable = $('#document_list').DataTable({
		...
		'sAjaxSource'    : '<?php echo site_url();?>'+'/candidate/document_details/'+id,
...
function delete_data(id)
{
	swal({
		...
		var	doc_id = id;
		$.ajax({
			url: '<?php echo site_url();?>/candidate/delete_doc',
			// dataType :"json",
			data : {doc_id: doc_id},
			type: 'POST',
