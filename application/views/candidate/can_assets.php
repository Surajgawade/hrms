				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/candidate/assign_assets/<?php echo $this->uri->segment(3);?>">
...
<script>
	...
	{		
		swal({
			...
			var  can_asset_id = id;
			$.ajax({
				url: '<?php echo site_url();?>/candidate/delete_asset',
				data : {can_asset_id: can_asset_id},
				type: 'POST',
