					...
					<h1 class="well headline">Add Employee Billing Details</h1>
						<div class="col-sm-12 col-xs-12 profile_bg">
							...
							<div class="row">
								...
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<select class="form-control" id="rate_type" name="rate_type" class="web" style="width: 100%">
							...
							<div class="row">
								...
								<div class="col-lg-10 col-sm-9 col-xs-12">
									<div class="form-group">
										<div class="form-control-wrapper form-control-icon-right">
											<input class="form-control number" placeholder="Enter Amount" type="text" maxlength="6" minlength="1" name="amount" id="amount" required >
								...
								<div class="col-lg-4 col-sm-9 col-xs-12">
	       						<div class="date form-group">
									<div class="input-group input-append date" id="datePicker">
										<input type="text" class="form-control" name="from_date" id="from_date" placeholder="DD/MM/YYYY" required />
