...
<body class="randbg">
	...
	<?php if(($this->input->cookie('cookie_email') != NULL) && !empty($this->input->cookie('cookie_email')))
    {
...
?>
  ...
  <div class="container">
    <div class="brand">    
      <a href="#"><img class="logo_img" src="<?php echo $logo_img;?>" alt=""></a>
    </div>
    <nav>
	...
	<div class="col-md-12 main_content">
		...
		<div class="col-md-5">
			<div class="content-w3ls">
				<h2 class="agileits1">Sign In Form</h2>
				<div class="content-agile2">
					<div class="checkpass">
								...
								<form name="Login" class="form-signin" method="post" action="<?php echo site_url();?>/login/process" id="Login">
			...
			$(document).ready(function()
			{
				...
				$('#forgot_submit').click(function(){
					...
					else
					{
						...
						$.ajax({
							url: '<?php echo site_url();?>/Login/check_availability',
