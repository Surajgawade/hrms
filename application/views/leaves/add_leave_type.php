	...
	<div class="col-sm-12 well">
		 <div class="row">
			<form data-toggle="validator" class="col-sm-12" id="add_leave" action="<?php echo site_url('leave_management/save_leave_type');?>" method="post">
				...
				<h1 class="well headline">Add Leave Type</h1>
					<div class="col-sm-12 col-xs-12 profile_bg">						
							...
							<div class="col-lg-10 col-sm-9 col-xs-12">
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input class="form-control" placeholder="Enter Leave Title" type="text" name="leave_title" id="leave_title" required data-error="Please Enter Leave Title">
						...
						<div class="row">
							...
							<div class="col-lg-10 col-sm-9 col-xs-12">
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input class="form-control" placeholder="Acronym" type="text" name="acronym" id="acronym" required data-error="Please Enter Acronym">
										<div class="help-block with-errors error_msg"></div>
									</div>
								</div>
							</div>
