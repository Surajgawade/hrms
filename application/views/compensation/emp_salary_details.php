<body class="with-side-menu-addl-full">
				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/compensation/add_edit_employee_salary_details">
								<button class="btn btn-inline btn-primary ladda-button" data-style="expand-right">
								<span class="ladda-label">Add Salary Details</span>
	...
	function get_emp_salarydetails()
	{
		...
		oTable = $('#emp_salarydetails').DataTable({
			...
			"aoColumns": [
				...
				{"sName": "gross_pay", "mData": "gross_pay" ,"bSortable":false},
			...
			'sAjaxSource'    : '<?php echo site_url();?>'+'/compensation/list_emp_salarydetails',
	...
	function delete_empsalary(sd_id)
	{
		swal({
			title: 'Are you sure?',
			...
			$.ajax({
				url: '<?php echo site_url();?>/compensation/delete_saldetails',
				data : {sd_id: sd_id},
				type: 'POST',
