<body class="with-side-menu-addl-full">
				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/compensation/generate_salary_slip">
								<button class="btn btn-inline btn-primary ladda-button" data-style="expand-right">
								<span class="ladda-label">Generate Salary Slip</span>
	...
	function list_monthly_salaryslips()
	{
		...
		oTable = $('#list_monthly_salaryslips').DataTable({
			...
			'sAjaxSource'    : '<?php echo site_url();?>'+'/compensation/list_monthly_salaryslips',
	...
	function delete_salaryslip(salary_slip_id)
	{
		swal({
			title: 'Are you sure?',
			...
			$.ajax({
				url: '<?php echo site_url();?>/compensation/delete_salaryslip',
