		...
		<div class="well" style="margin-bottom:20px;">
			<div class="row">
				<form data-toggle="validator" class="col-sm-12" id="menu_frm" action="" method="post">
					<input type="hidden" name="id" id="id" value="<?php echo !(empty($dep_details['id'])) ? $dep_details['id'] : '';?>">				
					<h1 class="well headline">Add / Edit Department Details</h1>
								...
								<div class="col-lg-10 col-sm-9 col-xs-12">
									<div class="form-group">
										<div class="form-control-wrapper form-control-icon-right">
											<input class="form-control" placeholder="Department Name" type="text" name="title" id="title" value="<?php echo !(empty($dep_details['title'])) ? $dep_details['title'] : '';?>" required data-error="Please Enter Department Name">
