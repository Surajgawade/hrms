				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/jobs/add_edit_designation">
								<button class="btn btn-inline btn-primary ladda-button" data-style="expand-right">
								<span class="ladda-label">Add New Designation</span>
	...
	function delete_designation(id)
		{
			swal({
				...
				$.ajax({
					url: '<?php echo site_url();?>/jobs/delete_designation',
					data : {id: id},
					type: 'POST',
	...
	function get_list()
		{
			...
			oTable = $('#list').DataTable({
				...
				'sAjaxSource'    : '<?php echo site_url();?>'+'/jobs/view_designation_list',
