				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="add_btn col-md-2">
							<a href="<?php echo site_url();?>/jobs/add_edit_department">
								<button class="btn btn-inline btn-primary ladda-button" data-style="expand-right">
								<span class="ladda-label">Add New Department</span>
	...
	function delete_department(id)
		{
			swal({
				...
				$.ajax({
					url: '<?php echo site_url();?>/jobs/delete_department',
					data : {id: id},
					type: 'POST',
	...
	function get_list()
		{
			...
			oTable = $('#list').DataTable({
				...
				'sAjaxSource'    : '<?php echo site_url();?>'+'/jobs/view_department_list',
