                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;">Reset Password</span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;Greetings for the day.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;This is to bring your kind attention that you can update your password by clicking on the below link to choose a new one.
                            </td>
                        </tr>
                        <tr style="text-align: center;">
                              <td class="button">
                                <div>
                                     <a class="button-mobile" href="<?php echo site_url("login/reset_password".'?em='.base64_encode($email));?>&d=<?php echo strtotime(date('Y-m-d h:i:s')); ?>" style="background-color:#e3975b;color:#ffffff;display:inline-block;font-size:15px;font-weight:600;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Reset Password</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">
                               &emsp;If you need not change then kindly ignore this mail. 
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
