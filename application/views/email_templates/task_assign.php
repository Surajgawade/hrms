...
<head>
    ...
    <title>Task Assigned-HRMS</title>
    <style type="text/css">
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp; This to bring your kind notice that the user has assigned you a new task that's "<?php echo $task['task_name']; ?>". The due date for the task is <?php echo db_to_date($task['tat']); ?>. <br> Please check your account for more details and brief about assigned task.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
