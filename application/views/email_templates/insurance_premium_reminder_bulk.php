...
<head>
    ...
    <title>Insurance Premium Bulk Reminder-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Insurance Premium Bulk Reminder</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;This is for your kind reminder that the below user's Insurance Premium policy is about to expire in the below mentioned dates. Kindly find below the details regarding Insurance Premium of the resources including Policy number, Premium Amount and expiry date. 
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                             <table cellspacing="0" cellpadding="0" width="100%" class="w320" border="1" style="font-weight:600; text-align: center;">
                                  <tr>
                                      <th>Employee Name</th>
                                      <th>Policy Number</th>
                                  ...
                                  <tr>
                                      <td class="free-text">
                                         <?php echo $value['can_name']; ?>
                                      </td>
                                      <td class="free-text">
                                        <?php echo $value['policy_no']; ?>
                                      </td>
                                      <td class="free-text">
                                        <?php echo $value['premium_amnt']; ?>
                                      </td>
                                      <td class="free-text">
                                         <?php echo db_to_date($value['ins_expire_date']); ?>
                                      </td>
                                  </tr>
                                  <?php } } else { ?>
                                      <tr>
                                          <td colspan="4" class="free-text">No records found</td>
                                      </tr>
                                <?php } ?>
                            </table>
                        </tr>
                        <tr>
                            <td style="text-align: left; padding-left: 20px">
                                Kindly write back for any concern. 
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left; padding-left: 20px">
