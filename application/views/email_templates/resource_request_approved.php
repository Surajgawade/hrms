...
<head>
    ...
    <title>Resource Request Approved-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Resource Request Approved</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp; This to let you know that your resource request has been approved for resource type <?php echo $title;?>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: left">
                                No of positions : <?php echo $no_of_positions;?>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               Job description : <?php echo $job_description;?>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
