...
<head>
    ...
    <title>Insurance Premium Reminder-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Insurance Premium Reminder</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;Below are the details of the user's insurance premium for your kind perusal. Please check for the due date and validity of the resources Insurance Premium.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                             <table cellspacing="0" cellpadding="0" width="100%" class="w320" border="1" style="font-weight:600; text-align: center;">
                                  ...
                                  <tr>
                                      <td>
                                         <?php echo $candidate['can_name']; ?>
                                      </td>
                                      <td>
                                          <?php echo db_to_date($insurance['ins_expire_date']); ?>
                                      </td>
                                      <td>
                                          <?php echo $insurance['policy_no'];?> 
                                      </td>
                                      <td>
                                          <?php echo $insurance['premium_amnt'];?> 
                                      </td>
                                  </tr>
                            </table>
                        </tr>
