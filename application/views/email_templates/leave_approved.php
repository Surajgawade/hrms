...
<head>
    ...
    <title>Leave Approved-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Leave Approved</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;Your leave application approved !
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                              &emsp;For dates : From <?php echo format_date($from_date);?> To <?php echo format_date($to_date);?>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
