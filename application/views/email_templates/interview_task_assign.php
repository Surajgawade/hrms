...
<head>
    ...
    <title>Interview Task Assigned-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Task Assigned</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        <tr>
                            <td style="text-align: left">
                               Dear <?php echo $candidate['can_name']; ?>,<br/>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;This is to remind you that a new interview task is assigned to you for the designation of <?php echo $profile['title']; ?>. Other details such as Job Description, number of positions, budget per candidate and professional experience are mentioned below.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                             <table cellspacing="0" cellpadding="0" width="100%" class="w320" border="1" style=" text-align: center; color:#333;">
                                   <tr>
                                      ...
                                      <th>Budget per Candidate</th>
                                      <th>Experience (in years)</th>
                                  </tr>
                                  <tr>
                                      <td> <?php echo $profile['title']; ?></td>
                                      <td> <?php echo $resource['job_description']; ?></td>
                                      <td> <?php echo $resource['keywords']; ?></td>
                                      <td> <?php echo $resource['no_of_positions']; ?></td>
                                      <td> <?php echo $resource['budget']; ?></td>
                                      <td> <?php echo $resource['experience']; ?></td>
                                  </tr>
                            </table>
                        </tr>
                        <tr>
