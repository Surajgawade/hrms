                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;"><b>Job Opening</b></span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        <tr>
                            <td style="text-align: left">
                                Hi, <?php echo $referto_name;?>,<br/>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;This is to bring your notice about the job opening for designation of <?php echo $job_title;?>. The required resources for this designation are <?php echo $no_of_position;?>.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;The Job Roles, Duties and Responsibilities for this job vacancy are below - <br><?php echo $message;?>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               <?php $company_details =  $this->config->item('job_refer');?>
                                <?php echo 'Address : ' .$company_details['company_name'];?>,<br/>
                                <?php echo $company_details['address'];?>,<br/>
                                <?php echo $company_details['contact_no'];?>,<br/>
                                <?php echo $company_details['email_id'];?><br/>
                            </td>
                        </tr>
                    </table>
                </center>
