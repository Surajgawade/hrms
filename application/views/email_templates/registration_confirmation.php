...
<head>
    ...
    <title>Registration Confirmation-HRMS</title>
    <style type="text/css">
                            ...
                            <td width="100%" height="50" valign="top" style="text-align: center; vertical-align:middle;">
                                <center>
                                    <table cellpadding="0" cellspacing="1" class="w320" width="50%">
                                        <tr>
                                            <td style="color: #fff; ">
                                                <span style="font-size: 24px; vertical-align: middle;">Activate Your Account</span>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="1" width="100%" class="w320">
                        <tr>
                            <td style="text-align: left">
                                Dear <?php echo $can_name;?>,<br/>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;Please take a look into this matter.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: justify;text-justify: inter-word;">
                               &emsp;This is regarding the confirmation of registration for HRMS software. Your account activation Is now processed. Kindly find below the credentials and confirm the registered email ID for your account.
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: left;">
                               Email ID : <strong><?php echo $email;?></strong> <br/>
                            </td>
                        </tr>
                        <tr height="10px"></tr>
                        <tr>
                            <td style="text-align: left;">
                               Password ; <strong>raoson1234</strong><br />
                            </td>
                        </tr>
                        <tr height="10px"></tr>
