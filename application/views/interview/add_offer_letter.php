...
<div class="container-fluid">
	<?php $title="offer_letter"; $this->load->view('interview/top_menu');?>
	<div class="well">
	...
	$(document).ready(function () {
        ...
        branding: false
  		...
  		$("#submit_letter").click(function(){
  			...
  			$.ajax({
  				url:'<?php echo site_url();?>/interview/offer_letter',
  				type:'post',
