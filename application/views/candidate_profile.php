	...
	<div class="col-sm-12">
		<div class="row">
			<div class="menu_btns col-sm-12">
				<a href="<?php echo base_url();?>bank_details">
							...
							<div class=col-lg-10>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input class="form-control " placeholder="Your User ID" type="text" name="user_id" required="" oninvalid="this.setCustomValidity('Please Enter valid ID.')" 
oninput="setCustomValidity('')">
						...
						<div class="row">
							...
							<div class=col-lg-10>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input class="form-control alpha_only" placeholder="Your Full Name" type="text" name="can_name" required="" oninvalid="this.setCustomValidity('Please Enter valid Name')" 
oninput="setCustomValidity('')">
										<i class="fa fa-user"></i>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class=col-lg-10>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<textarea placeholder="Your Permanent Address" rows="3" class="form-control" required=""></textarea>
						...
						<div class="row">
							...
							<div class=col-lg-10>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Your Email Address" class="form-control" name="email" required="" oninvalid="this.setCustomValidity('Please Enter valid Email ID')" 
oninput="setCustomValidity('')">
						...
						<div class="row">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="+91 -" class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter valid Mobile No.')" 
oninput="setCustomValidity('')">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Phone Number Here.." class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter valid Phone No.')" 
oninput="setCustomValidity('')">
						...
						<div class="row">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Your Current CTC" class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter Current CTC.')" 
oninput="setCustomValidity('')">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Your Expected CTC" class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter Expected No.')" 
oninput="setCustomValidity('')">
										<i class="fa fa-rupee"></i>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Emergency Contact Name" class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter Emergency Name')" 
oninput="setCustomValidity('')">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Emergency Contact Number" class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter Emergency Contact No.')" 
oninput="setCustomValidity('')">
										<i class="fa fa fa-phone"></i>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Adhaar Card No." class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter valid Adhaar No.')" 
oninput="setCustomValidity('')">
							...
							<div class=col-lg-4>
								<div class="form-group">
									<div class="form-control-wrapper form-control-icon-right">
										<input type="text" placeholder="Pan Card No." class="form-control" required="" oninvalid="this.setCustomValidity('Please Enter valid Pan No.')" 
oninput="setCustomValidity('')">
										<i class="font-icon font-icon-doc"></i>
									</div>
								</div>
