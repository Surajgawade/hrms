							...
							<div class="col-sm-12 col-xs-12 profile_bg">
									...
									<div class="col-lg-10 col-sm-9 col-xs-12">
										<div class="form-group">
											<div class="form-control-wrapper form-control-icon-right">
												<input class="form-control" placeholder="Menu Name" type="text" name="menu_name" id="menu_name" required="" value="<?php echo $menu_details->menu_name;?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-10 col-sm-9 col-xs-12">
										<div class="form-group">
											<div class="form-control-wrapper form-control-icon-right">
												<input required="" class="form-control" placeholder="Menu Description" type="text" name="menu_description" id="menu_description" value="<?php echo $menu_details->menu_description;?>">
											</div>
										</div>
									</div>
								</div>
