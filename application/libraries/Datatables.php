  ...
  class Datatables
  {
    ...
    */
    ...
    private function get_filtering()
    {
        ...
        //file_put_contents('/tmp/test.txt', print_r($this->ci->input->post(), true));
...
/*private function get_filtering()
    ...
    */
    ...
    { 
      // file_put_contents('/tmp/test.txt', print_r($this->ci->db->last_query(), true));
    ...
    private function get_total_results($filtering = FALSE)
    {
      ...
      if(strlen($this->distinct) > 0)
      {
        ...
        $this->ci->db->select($this->columns);
                    ...
                    $lst_qry = $this->ci->db->last_query();
                    // file_put_contents('/tmp/test1.txt', print_r($lst_qry ."\n" ,true) . "\n\n", FILE_APPEND); 
