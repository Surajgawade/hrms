...
class Record_not_found extends My_Controller {

	public function index()
	{
		$this->load_view('record_not_found',"Record not found", $this->content);
	}
	...
	private function load_view($viewname = "blank_page",$page_title)
    {
        ...
        $this->masterpage->addContentPage('errors/'.$viewname,'content',$this->content);
