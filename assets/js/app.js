$(document).ready(function() {
    ...
    if (!("ontouchstart" in document.documentElement)) {
        ...
        $('.event-calendar').jScrollPane(jScrollOptions);
        $('.travels_month').jScrollPane(jScrollOptions);
        $('.birthday_block').jScrollPane(jScrollOptions); 
        $('.curr_jobs').jScrollPane(jScrollOptions);
    }
...
! function(a) {
    ...
    a(document).ready(function() {
        var H = a("#mainColorScheme");
        a("#open-switcher").on("click", function() {
            a("#open-switcher").css("display", "none"), a("#switcher-color").animate({
                right: "0px"
            }, 200, "linear", function() {
                a("#close-switcher").fadeIn(200)
            })
        }), a("#close-switcher").on("click", function() {
            a("#close-switcher").css("display", "none"), a("#switcher-color").animate({
                right: "-202px"
            }, 200, "linear", function() {
                a("#open-switcher").fadeIn(200)
            })
        }), a("#mainColors li").on("click", function() {
            H.attr("href", a(this).attr("data-path")), a(this).addClass("active").siblings().removeClass("active")
        })
    })
}(jQuery);